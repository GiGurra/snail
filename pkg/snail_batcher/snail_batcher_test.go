...
func TestPerfOfNewSnailBatcher_producersWaitWhileWorkerIsBusy(t *testing.T) {
	...
	// we should have received between 1000 and 1600 (1300 is the exact, due to triple buffering)
	if nReceived < 1000 || nReceived > 1600 {
		t.Fatalf("unexpected nReceived %d", nReceived)
	}
}
